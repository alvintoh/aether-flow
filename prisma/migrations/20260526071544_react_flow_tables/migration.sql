...
-- AddForeignKey
ALTER TABLE "Connection" ADD CONSTRAINT "Connection_connectionId_fkey" FOREIGN KEY ("connectionId") REFERENCES "Workflow"("id") ON DELETE CASCADE ON UPDATE CASCADE;
