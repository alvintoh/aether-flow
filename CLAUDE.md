...
| `qa`           | Identify bugs, regressions, and quality issues — feeds `/create-issue` |
...
| `/qa-issue`       | Package a bug or QA finding into a structured GitHub issue via `gh issue create` |
