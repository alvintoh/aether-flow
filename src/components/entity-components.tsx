  ...
  return (
    <div className="flex flex-row items-center justify-between gap-x-4">
      <div className="flex flex-col">
        <h1 className="text-lgmd:text-dl font-semibold">{title}</h1>
        {description && (
...
interface EmptyStateViewProps extends StateViewProps {
  onNew?: () => void;
}

export const EmptyStateView = ({ message, onNew }: EmptyStateViewProps) => {
  return (
